<?php $__env->startSection('title', 'Record Core Competencies'); ?>
...
<div class="card p-3 mb-4">
    <form method="GET" action="<?php echo e(route('admin.cbc.core_competencies.grid')); ?>" class="row g-2 align-items-end">
        <div class="col-md-3">
        ...
        <div class="col-md-4">
            ...
            <select name="competency" class="form-select" onchange="this.form.submit()">
                ...
                <?php $__currentLoopData = \App\Models\CbcCoreCompetencyRecord::COMPETENCIES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($value); ?>" <?php if($competency === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div class="col-md-3">
...
<?php if($classId && $competency): ?>
<form method="POST" action="<?php echo e(route('admin.cbc.core_competencies.store')); ?>">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="competency" value="<?php echo e($competency); ?>">
    ...
    <div class="card">
        <table class="table mb-0 align-middle">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php $existing = $student->coreCompetencyRecords->first()?->performance_level; ?>
                <tr>
                    <td><?php echo e($student->admission_no); ?></td>
                    <td><?php echo e($student->user->name); ?></td>
                    <td>
                        <select name="levels[<?php echo e($student->id); ?>]" class="form-select form-select-sm">
                            <option value="">— Not rated —</option>
                            <?php $__currentLoopData = \App\Models\CbcCoreCompetencyRecord::LEVELS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\luqman\Desktop\SCHOOLMANAGEMENT\sms\resources\views/admin/cbc/core_competencies.blade.php ENDPATH**/ ?>