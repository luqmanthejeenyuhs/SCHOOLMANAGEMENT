...
{
    /**
     * GET /login (generic) or GET /school/{school}/login (branded).
     *
     * When a school is resolved from the URL we show its logo/name instead
    ...
    /**
     * POST /login or POST /school/{school}/login.
     *
