    ...
    <form method="POST" action="{{ route('admin.employees.store') }}">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="shif_number" class="form-control" value="{{ old('shif_number') }}">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="number" step="0.01" name="house_allowance" class="form-control" value="{{ old('house_allowance', 0) }}">
            </div>
            <div class="col-md-4">
