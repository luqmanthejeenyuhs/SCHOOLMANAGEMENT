...
<form method="POST" action="{{ route('superadmin.schools.store') }}">
    ...
    <div class="card p-4 mb-3" style="max-width:700px;">
        ...
        <div class="mb-3">
            ...
            <div class="form-text">Lowercase letters, numbers, and hyphens only — this becomes their branded login link, e.g. <code>{{ url('/school') }}/littleheaven/login</code>.</div>
        </div>
        <div class="mb-3">
    ...
    <div class="card p-4 mb-3" style="max-width:700px;">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <label class="form-label">Admin Email (for account notifications)</label>
            ...
            <div class="col-md-6 mb-3">
                <label class="form-label">Admin Username (used to log in)</label>
                <input type="text" name="admin_username" class="form-control" value="{{ old('admin_username') }}" required pattern="[A-Za-z0-9_\-]+" autocapitalize="none" autocorrect="off">
            </div>
        </div>
    </div>
